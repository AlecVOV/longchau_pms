  ...
  setup(__props) {
    ...
    const menuCategories = [
      ...
      },
      {
        id: "main-courses",
        name: "Main Courses",
        description: "Indulge in our chef's signature entr\xE9es, each plate a masterpiece of flavor and presentation."
      },
      {
        id: "seafood",
        name: "From the Sea",
    ...
    const menuItems = [
      // Starters
      {
        ...
        description: "Pan-seared sea scallops with cauliflower pur\xE9e, pancetta crisp, and micro greens",
        price: 18.99,
        isVegetarian: false,
        isGlutenFree: true,
        isSignature: true,
      ...
      },
      {
        ...
        description: "Toasted artisan bread topped with saut\xE9ed wild mushrooms, truffle oil, and shaved Parmesan",
        price: 14.99,
        isVegetarian: true,
        isGlutenFree: false,
        isSignature: false,
      ...
      },
      {
        ...
        description: "Free-range chicken with lemon thyme jus, root vegetable pur\xE9e, and glazed baby carrots",
        price: 32.99,
        isVegetarian: false,
        isGlutenFree: true,
        isSignature: false,
...
//# sourceMappingURL=menu-BH5WVns_.mjs.map
